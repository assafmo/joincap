...
| ----------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Corrupt input global header                                                                           | <ul><li>`joincap -w out_joincap.pcap pcap_examples/bad_global.pcap`</li><li>`mergecap -w out_mergecap.pcap pcap_examples/bad_global.pcap`</li><li>`tcpslice -w out_tcpslice.pcap pcap_examples/bad_global.pcap`</li></ul>                                                                                                                                                                                                                                                                                                                                                        |
| Corrupt input packet header                                                                           | <ul><li>`joincap -w out_joincap.pcap pcap_examples/bad_first_header.pcap`</li><li>`mergecap -w out_mergecap.pcap pcap_examples/bad_first_header.pcap`</li><li>`tcpslice -w out_tcpslice.pcap pcap_examples/bad_first_header.pcap`</li></ul>                                                                                                                                                                                                                                                                                                                                      |
| Unexpectd EOF<br>(last packet data is truncated)                                                      | <ul><li>`joincap -w out_joincap.pcap pcap_examples/unexpected_eof_on_first_packet.pcap`</li><li>`mergecap -w out_mergecap.pcap pcap_examples/unexpected_eof_on_first_packet.pcap`</li><li>`tcpslice -w out_tcpslice.pcap pcap_examples/unexpected_eof_on_first_packet.pcap`</li><li>`joincap -w out_joincap.pcap pcap_examples/unexpected_eof_on_second_packet.pcap`</li><li>`mergecap -w out_mergecap.pcap pcap_examples/unexpected_eof_on_second_packet.pcap`</li><li>`tcpslice -w out_tcpslice.pcap pcap_examples/unexpected_eof_on_second_packet.pcap`</li></ul>             |
| Input pcap has no packets<br>(global header is ok, no first packet header)                            | <ul><li>`joincap -w out_joincap.pcap pcap_examples/ok.pcap pcap_examples/no_packets.pcap`</li><li>`mergecap -w out_mergecap.pcap pcap_examples/ok.pcap pcap_examples/no_packets.pcap`</li><li>`tcpslice -w out_tcpslice.pcap pcap_examples/ok.pcap pcap_examples/no_packets.pcap`</li></ul>                                                                                                                                                                                                                                                                                      |
| Input file size is smaller than 24 bytes<br>(global header is truncated)                              | <ul><li>`joincap -w out_joincap.pcap pcap_examples/ok.pcap pcap_examples/empty`</li><li>`mergecap -w out_mergecap.pcap pcap_examples/ok.pcap pcap_examples/empty`</li><li>`tcpslice -w out_tcpslice.pcap pcap_examples/ok.pcap pcap_examples/empty`</li><li>`joincap -w out_joincap.pcap pcap_examples/ok.pcap pcap_examples/partial_global_header.pcap`</li><li>`mergecap -w out_mergecap.pcap pcap_examples/ok.pcap pcap_examples/partial_global_header.pcap`</li><li>`tcpslice -w out_tcpslice.pcap pcap_examples/ok.pcap pcap_examples/partial_global_header.pcap`</li></ul> |
| Input file size is between 24 and 40 bytes<br>(global header is ok, first packet header is truncated) | <ul><li>`joincap -w out_joincap.pcap pcap_examples/ok.pcap pcap_examples/partial_first_header.pcap`</li><li>`mergecap -w out_mergecap.pcap pcap_examples/ok.pcap pcap_examples/partial_first_header.pcap`</li><li>`tcpslice -w out_tcpslice.pcap pcap_examples/ok.pcap pcap_examples/partial_first_header.pcap`</li></ul>                                                                                                                                                                                                                                                        |
| Input file doesn't exists                                                                             | <ul><li>`joincap -w out_joincap.pcap pcap_examples/ok.pcap ./not_here`</li><li>`mergecap -w out_mergecap.pcap pcap_examples/ok.pcap ./not_here`</li><li>`tcpslice -w out_tcpslice.pcap pcap_examples/ok.pcap ./not_here`</li></ul>                                                                                                                                                                                                                                                                                                                                               |
| Input file is a directory                                                                             | <ul><li>`joincap -w out_joincap.pcap pcap_examples/ok.pcap pcap_examples/`</li><li>`mergecap -w out_mergecap.pcap pcap_examples/ok.pcap pcap_examples/`</li><li>`tcpslice -w out_tcpslice.pcap pcap_examples/ok.pcap pcap_examples/`</li></ul>                                                                                                                                                                                                                                                                                                                                   |
| Input file end is garbage                                                                             | <ul><li>`joincap -w out_joincap.pcap pcap_examples/ok.pcap pcap_examples/bad_end.pcap`</li><li>`mergecap -w out_mergecap.pcap pcap_examples/ok.pcap pcap_examples/bad_end.pcap`</li><li>`tcpslice -w out_tcpslice.pcap pcap_examples/ok.pcap pcap_examples/bad_end.pcap`</li></ul>                                                                                                                                                                                                                                                                                               |
| Input file is gzipped (.pcap.gz)                                                                      | <ul><li>`joincap -w out_joincap.pcap pcap_examples/ok.pcap.gz`</li><li>`mergecap -w out_mergecap.pcap pcap_examples/ok.pcap.gz`</li><li>`tcpslice -w out_tcpslice.pcap pcap_examples/ok.pcap.gz`</li></ul>                                                                                                                                                                                                                                                                                                                                                                       |
