...
| Unexpectd EOF (last packet data is truncated)                                                      | :heavy_check_mark: Ignores the last packet                              | :heavy_check_mark: Ignores the last packet                                                                                                                            | :heavy_check_mark: Ignores the last packet                                                                                                                                        | Merge `pcap_examples/unexpected_eof_on_first_packet.pcap` or `pcap_examples/unexpected_eof_on_second_packet.pcap` |
